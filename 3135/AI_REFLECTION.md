...
| Item | Answer |
|---|---|
| OJ problem number/title | 3111 |
| OJ submission ID, if submitted | 628925 |
| OJ status | Pass |
...
```text
ถามเกี่ยวกับการทำงานlogicโค้ด แล้วก็methodที่ดีกว่าในข้อนี้
```
...
```text
ข้อนี้ถ้าสนแค่เลขซ่ำใช้setจะดีกว่าlistเพราะโค้ดจะทำงานเร็วกว่า
Logicการทำงานผิดพลาดเพราะมีบางเคสที่สูตรคณิตนั้นแบบตรงๆไม่สามารถทำงานได้
```
...
```text
ผมนำโค้ดพร้อมตัวอย่างมาดัดแปลงเข้ากับโค้ดตัวเอง เปลี่ยนlistเป็นset
เปลี่ยนวิธีคำนวณด้านlogic
```

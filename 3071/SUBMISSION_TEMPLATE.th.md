...
```text
รับตัวแปร
รูปเช็คว่ามีเลขไหนเข้าconditionย้างไล่ตั้งแต่ A ถึง B
ถ้ามีให้นับขึ้นบวก 1
```
...
```text
Step 1:รับตัวแปร
Step 2:รูปเช็คว่ามีเลขไหนเข้าconditionย้างไล่ตั้งแต่ A ถึง B
Step 3:ถ้ามีให้นับขึ้นบวก 1
```

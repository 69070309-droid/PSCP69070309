...
```text
รับค่า แล้วคำนวณให้ตรงกับตัวแปร
จากนั้นใช้math.ceilที่importมาปัดเศษขึ้น
```
...
```text
Step 1:รับค่า
Step 2:คำนวณให้ตรงกับตัวแปร
Step 3:ปัดเศษขึ้น print output ที่มากสุด
```

...
```text
รูปเช็คเลขแต่ตั้ง S ถึง E ดูว่ามีเลขไหนเป็นจำนวนเฉพาะเก็บเข้าlist
...
```text
Step 1:ลองทำรูปหาจำนวนเฉพาะ
Step 2:เช็คเงื่อนไข print list ออกมาดู
Step 3:แก้ ทำ outputตามโจทย์
```
...
```text
วิธ๊เดิมเพิ่มเติม วนลูปตั้งแต่S ถึง E
```

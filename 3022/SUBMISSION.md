...
```text
รับค่า อุณหภูมิเข้ามา
รับค่า หน่วยที่รับเข้ามา
รับค่าหน่วนที่ต้องแสดง
เช็คหน่วย คำนวณเปลี่ยนเป็น หน่วยที่ต้องแสดงผล
ใช้ condition ช่วยในการเลือกหน่วยสูตรคำนวณ
```
...
```text
Step 1:รับค่าเข้ามา
Step 2:ลองเช็คว่าได้ หน่วยอะไร
Step 3:output เป็นหน่วยที่ต้องแสดง
```
...
```text
-รับค่าเข้ามา
-เปลี่ยนเป็นCก่อนค่อยว่ากัน
-เช็คหน่วยว่าต้องการอะไร
-คำนวณ
-แสดงผล
```

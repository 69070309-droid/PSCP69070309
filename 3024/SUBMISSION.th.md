...
```text
-รับinput
-คิดเคสที่เป็นไปได้มากที่สุดที่จะขึ้นsurprising
-ดักเคสที่ไม่ควรจะเป็นติดลบ
```
...
```text
Step 1:รับinput
Step 2:คิดเคสที่เป็นไปได้มากที่สุดที่จะขึ้นsurprising
Step 3:ดูผลประกอบการ
```
...
```text
-ตอนแรกคิดไม่ออกเลยว่าจะหาcaseที่มีโอกาศขึ้นsurprisingยังไงในเมื่อไม่รู้สองตัวท้าย
-เพื่อนบอกลองคิดค่ามากสุด2ตัว
-ไอเดียมาเลย ลองคิดกรณีที่ตัวน้อยสุดห่างจากตัวมากสุดคือ มากสุด2ตัว-น้อยสุด
-เจอcase ติดลบ ต้องดัก เพื่อนบอกปัด0ใช้max
-ตอนแรกว่าจะใช้condition เพื่อนบอกปัด0ใช้max 
-better way
```
...
```text
เขาไกด์ แนวคิดทำให้ผมเข้าใจว่าโอกาศกับมากสุดทำงานยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำเองหมด ตัวมีไกด์ช่วยสบายเลย
```

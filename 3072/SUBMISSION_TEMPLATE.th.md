...
```text
Step 1:รัย text มา
Step 2:นับจำนวน เพื่อลูปนับ
Step 3:นับ เข้าcondition นับสระ
```
...
```text
Sample Testcases เข้าใจง่าย output ชัดเจน
```
...
```text
Sample Testcases ยากขึ้นแต่ยังทำงานต่อได้
```

...
```text
ถามเกี่ยวกับหลักการปัดเศษของโปรแกรม
```
...
```text
ถ้าอยากปัดเศษ0.5ขึ้นจะไม่มีbuild in functionให้ต้องimport decimalหรือเขียนฟังก์ชั้นเอง
```
...
```text
AI พยายามแก้โค้ดให้สั้นลงแต่ไม่ตรงตามformatที่อยากได้เลย ขอแค่หลักการฟังก์ชั่นปัดเศษเพื่อนำไปใช้ต่อเอง
```
...
```text
ไม่มีbuild in function เศร้า เสียใจ
```

...
```text
รับค่ามา 2 ค่า
ตัวแรก รัยมาเพื่อเอาไปเช็ค conditionต่อ
ตัวถุดมา เอามาเป็นจำนวนวันลูปรับค่าเพิ่ม
คำนวณตามปกติก่อนแล้วดูจุดทศนิยมตามโจทย์
```
...
```text
Step 1:ทำคอนดิชั่นปกติคำนวณ
Step 2:เช็คเลขที่ออกมา 2 ตำแหน่ง
Step 3:ปรับแก้วิธีการปัดเศษ
```
...
```text
เหมือนแผนแรก
แต่ต้องไปเพิ่มเติมฟังชั่นก์การปัดเศษเอง
เนื่องจากไม่มีbuilt in function
```
...
```text
case condition 2 ง่ายๆ เช็ค condition
```

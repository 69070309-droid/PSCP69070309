...
| OJ submission ID, if submitted | 	630835 |
| OJ status | Pass
...
```text
ใช้loopcheckเพิ่มเองเนื่องจากaiพยายามใช้จำนวนข้อมูลเข้ามาเป็นจำนวนที่ต้องตอบออกไปซึ่งไม่ตรงกับโจทย์
ืทำ condition เช็คร้านที่นับเอง
ทำlist output เอง
```
...
```text
ai เชื่อถือได้แค่บางส่วน
output listมีวิธีกำหนดการแสดงผลหลายแบบ
```

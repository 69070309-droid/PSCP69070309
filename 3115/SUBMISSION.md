...
```text
รับค่า2ตัว
เอาค่าตัวแรกไปลูปรับค่าเพิ่มเป็นเวลาเปิดปิดแต่ละร้านเก็บเข้าlist
ีรับค่าเวลาที่ไป
ทำลูปเช็คว่าเวลาไหนร้านเปิดกี่ร้าน
```
...
```text
Step 1:รับค่า2ตัว
Step 2:เอาค่าตัวแรกไปลูปรับค่าเพิ่มเป็นเวลาเปิดปิดแต่ละร้านเก็บเข้าlist
Step 3:รับค่าเวลาที่ไป
Step 4:ทำลูปเช็คว่าเวลาไหนร้านเปิดกี่ร้าน
Step 5:printออกมาให้list ออกมาเป็นตัวเลข ตัว เว้น ตัว
```
...
```text
วิธีเดิมเพิ่มเติมแก้บัคและformat
```

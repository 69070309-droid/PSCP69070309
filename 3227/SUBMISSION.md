...
```text
เช็คตัวหน้า เช็คตัวหลัง
ตอบ ตามเงื่อนไขทีให้มา
```
...
```text
Step 1:เช็คตัวหลังก่อน
Step 2:เช็คตัวหน้า int/string
Step 3:ทำตามcondition
```
...
```text
เปลี่ยนไปเช็คจำนวนstrแล้วค่อยเช็คint/strอีกที
```

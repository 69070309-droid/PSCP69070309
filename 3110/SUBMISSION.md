...
```text
รับค่า 2 ค่า เช็ค ค่าตัวแรกว่าเข้าเงื่อนไขไหนจากนั้นดำเนินการต่อตามโจทย์
```
...
```text
Step 1:รับค่า 2 ค่า
Step 2:เขียน condition if elif ธรรมดา
Step 3:output ตามcondition
```
...
```text
test case ที่เลขมีทศนิยมแต่เป็นศูนย์
```
